          ...
          <div class="container">
            <nav id="menuzord-right" class="menuzord default no-bg">
              ...
              <ul class="menuzord-menu">
                ...
                <style>
                  .menuzord .menuzord-menu>li:nth-child(7)>a {
          ...
          <div class="section-content text-center">
            <div class="row">
              <div class="col-md-6 col-md-offset-3 text-center">
                <h2 class="text-theme-colored font-36" style="color:#ff00ba!important;">Our Team</h2>
              </div>
            </div>
          </div>
        </div>
    ...
    <footer id="footer" class="footer" data-bg-img="images/footer-bg.png" data-bg-color="#25272e">
      ...
      <div class="footer-bottom bg-black-333">
        <div class="container pt-15 pb-10">
          <div class="row">
            <div class="col-md-6">
              <p>© 2018 All Assam Transgender Association <a href="https://www.webinfotech.net.in/" title="">Web Infotech</a> </p>
            </div>
