...
<div id="wrapper">
 ...
 <!-- <div id="preloader">
  ...
  <div class="main-content">
    ...
    <section class="inner-header divider layer-overlay overlay-dark" data-bg-img="images/bg/bg3.jpg">
      <div class="container pt-30 pb-30">
        <!-- Section Content -->
        <div class="section-content text-center">
          <div class="row"> 
            <div class="col-md-6 col-md-offset-3 text-center">
              <h2 class="text-theme-colored font-36" style="color:#ff00ba!important;">Transgender Legal Cell</h2>
        ...
        <div class="section-title text-center">
          <div class="row">
            <div class="col-md-10 col-md-offset-1">
              <h3 class="text-uppercase line-bottom-center mt-0">Our <span class="text-theme-colored font-weight-600">Justice Team</span></h3>
              <div class="title-icon">
                <i class="flaticon-charity-hand-holding-a-heart"></i>
                
              </div>
              <p>Transgender Legal Cell :- This legal cell initiative was taken to provide Pro-Bono, Legal Aid to Transgender in establishing their rights from various legal discrepancy & injustice they face in every space of their life.</p>
            </div>
          </div>
        </div>
        <div class="section-content">
          <div class="row">
            <div class="col-sm-6 col-md-3 col-lg-3 pb-sm-30">
              <div class="volunteer">
                <img class="img-fullwidth img-responsive" src="images/team/1.jpeg" alt="">                
                <div class="volunteer-info bg-theme-colored">
                  <h3 class="mb-0 mt-0"><a class="text-white" href="#">Swati Bidhan Baruah</a></h3>
                  <p class="text-white">baruahbidhan2@gmail.com</p>
            ...
            <div class="col-sm-6 col-md-3 col-lg-3 pb-sm-30">
              <div class="volunteer">
                <img class="img-fullwidth img-responsive" src="images/team/2.jpeg" alt="">                
                <div class="volunteer-info bg-theme-colored">
                  <h3 class="mb-0 mt-0"><a class="text-white" href="#">Upasana Duarah</a></h3>
                  <p class="text-white">upasana24@gmail.com</p>
                   <div class="volunteer-more text-white">
            ...
            <div class="col-sm-6 col-md-3 col-lg-3 pb-sm-30">
              <div class="volunteer">
                <img class="img-fullwidth img-responsive" src="images/team/3.jpeg" alt="">                
                <div class="volunteer-info bg-theme-colored">
                  <h3 class="mb-0 mt-0"><a class="text-white" href="#">Sanjana Newar</a></h3>
                  <p class="text-white">newarsanjana@gmail.com</p>
                   <div class="volunteer-more text-white">
            ...
            <div class="col-sm-6 col-md-3 col-lg-3 pb-sm-30">
              <div class="volunteer">
                <img class="img-fullwidth img-responsive" src="images/team/4.jpeg" alt="">                
                <div class="volunteer-info bg-theme-colored">
                  <h3 class="mb-0 mt-0"><a class="text-white" href="#">Rizwan Yasin</a></h3>
                  <p class="text-white">rizwanyasin@rediffmail.com</p>
                   <div class="volunteer-more text-white">
            ...
            <!--<div class="col-sm-6 col-md-3 col-lg-3 pb-sm-30">-->
            <!--  <div class="volunteer">-->
            <!--    <img class="img-fullwidth img-responsive" src="images/team/5.jpeg" alt="">                -->
            <!--    <div class="volunteer-info bg-theme-colored">-->
            <!--      <h3 class="mb-0 mt-0"><a class="text-white" href="#">Deepshika Buragohain</a></h3>-->
            <!--      <p class="text-white">deepshikhaburagohain93@gmail.com</p>-->
            <!--       <div class="volunteer-more text-white">-->
