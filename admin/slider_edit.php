	...
	<div class="contain">
        ...
        while ($slider_row=mysqli_fetch_array($sql)) {
          $slider .='<li  style="width: 45%; height: auto;  background-color: #3b576e">
							...
							<div class="options">
								<a href="slider_edit.php?edit_id='.$slider_row['id'].'"><i class="icon icon-pencil"></i></a>
								<a href="php/delete_slider.php?delete_id='.$slider_row['id'].'"><i class="icon icon-remove"></i></a>
							</div>
