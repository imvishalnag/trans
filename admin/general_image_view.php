	...
	<div class="contain">
				...
				<div id="bread" class="col-md-12">
					<div class="crumbs">
						<ol class="breadcrumb">
							...
							<li class="active">All General Images</li>
						</ol>
					</div>
				</div>
				<div class="row">
        ...
        while ($row=mysqli_fetch_array($result)) {
          $press_data .='<tr class="odd gradeX">
										...
										<td>'.$i.'</td>
										<td><img src="../uploads/general/thumb/'.$row['image'].'" alt=""></td>
										<td>'.$row['uploaded_date'].'</td>
										<td><a class="btn btn-danger" href="php/general_image_delete.php?del_id='.$row['id'].'">Delete</a></td>';
									$i++;

        }
        ?>
					<div class="wdgt wdgt-primary">
						<div class="wdgt-header"><i class="fa fa-table"></i>All General Images Datatables</div>
						<div class="wdgt-body">
